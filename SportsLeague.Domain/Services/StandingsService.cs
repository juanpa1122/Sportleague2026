...
namespace SportsLeague.Domain.Services
{
    public class StandingsService : IStandingsService
    {
        ...
        public StandingsService(ITournamentRepository tournamentRepository, ITournamentTeamRepository tournamentTeamRepository, IMatchRepository matchRepository, IMatchResultRepository matchResultRepository, IGoalRepository goalRepository, ICardRepository cardRepository, ILogger<StandingsService> logger)
        {
        ...
        public async Task<object> GetTopScorersAsync(int tournamentId)
        {
            ...
            var scorerGoals = allGoals.Where(g => g.Type != GoalType.OwnGoal).ToList();
